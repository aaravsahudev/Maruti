        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects?.map((project, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white rounded-2xl shadow-xl hover-lift overflow-hidden"
            >
              <img 
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-solar-gold font-semibold">{project.yearlysSavings} Savings/Year</span>
                  <Button variant="ghost" size="sm" className="text-solar-blue hover:text-blue-700 transition-colors">
